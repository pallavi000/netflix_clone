...
function Footer() {
  return (
    ...
    <div className='call-request'>Questions? Call 1-844-505-2993 </div>

    <div className='row'>
        <div className='footer-column  col-md-3 mb-4'>
